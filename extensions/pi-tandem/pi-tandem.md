...
- Use `tandem_papercut` when small, non-blocking friction causes confusion, avoidable retries, or a workaround worth preserving. Then continue current work. Expected test failures, empty searches, and deliberate invalid probes are not automatically Papercuts.
