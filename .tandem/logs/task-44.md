...
completion:
  summary: "Accepted as test-covered behavior work. TUI Board moves now reuse shared CLI move/accord synchronization behavior, including ready-to-claimed sync for todo-to-in-progress moves."
  filesChanged: ["tandem/src/main.rs", "tandem/src/tui.rs"]
  validation: "cargo fmt --check && cargo test passed; regression coverage added"
---
