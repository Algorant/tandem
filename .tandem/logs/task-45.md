...
completion:
  summary: "Accepted as test-covered warning behavior. State/accord divergence warnings now surface in CLI read paths and TUI detail without collapsing workflow state, review metadata, and accord status."
  filesChanged: ["tandem/src/main.rs", "tandem/src/tui.rs"]
  validation: "cargo fmt --check && cargo test passed; regression coverage added for warnings and preserved divergence"
---
