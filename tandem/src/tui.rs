...
impl TuiApp {
    ...
    fn board_footer_text(&self) -> String {
        ...
        let commands = if self.focus == FocusPane::Detail {
            ...
            "Enter detail · A approve · R rework · C complete · e edit · ? help".to_string()
    ...
    fn draw_footer(&mut self, frame: &mut Frame<'_>, area: Rect) {
        ...
        let footer = Paragraph::new(Line::from(Span::styled(hints.clone(), style)));
        frame.render_widget(footer, area);
        self.register_footer_hits(area, &hints);
    }
        ...
        match self.view {
            TuiView::Board => {
                ...
                self.register_footer_hit(
                    ...
                    text,
                    "A approve",
                    HitAction::ShowValidationAction("approve"),
                );
                self.register_footer_hit(
                    area,
                    text,
                ...
                self.register_footer_hit(
                    ...
                    text,
                    "C complete",
                    HitAction::ShowValidationAction("complete"),
                );
